...
export default function PrivacyPolicyEN() {
  ...
  return (
    <main className="signature-sans min-h-screen bg-[#0B0B0B] text-[#F5F3EF]">
      <Helmet>
        <title>Privacy Policy | Aquí Golf Signature Projects</title>
        <meta name="description" content="Information about how Aquí Golf processes personal data submitted through its website." />
        <meta name="robots" content="noindex,follow" />
        <link rel="canonical" href="https://aquigolf.es/en/privacy-policy" />
      ...
      <section className="bg-[#F5F3EF] text-[#0B0B0B]">
        <div className="mx-auto max-w-[1200px] px-6 py-16 lg:px-10 lg:py-24">
          <div className="max-w-4xl space-y-10 text-sm font-light leading-7 text-black/65">
            <>
<LegalSection title="Data controller"><p>Data controller: Francisco Menacho<br />Email: info@aquigolf.es</p></LegalSection>
