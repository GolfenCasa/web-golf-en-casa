  ...
  return (
    <main className="signature-sans min-h-screen bg-[#0B0B0B] text-[#F5F3EF]">
      <Helmet>
        ...
        <meta
          name="description"
          content="Aquí Golf | Signature Projects. Bespoke luxury golf simulator design and installation for private residences, villas, architecture studios and premium developments."
        />
        <link rel="canonical" href="https://aquigolf.es/en/signature" />
        ...
        <meta property="og:url" content="https://aquigolf.es/en/signature" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@graph": [
              {
                "@type": "Service",
                "@id": "https://aquigolf.es/en/signature/#service",
          ...
          <form onSubmit={handleSubmit} className="grid gap-x-5 gap-y-6 sm:grid-cols-2">
            ...
            <FormField label="How did you hear about us? *" className="sm:col-span-2">
              ...
              >
                ...
                <option>I already knew Aquí Golf</option>
                <option>Other</option>
