...
export default function LegalNoticeEN() {
  ...
  return (
    <main className="signature-sans min-h-screen bg-[#0B0B0B] text-[#F5F3EF]">
      <Helmet>
        <title>Legal Notice | Aquí Golf Signature Projects</title>
      ...
      <section className="border-b border-white/10">
        <div className="mx-auto max-w-[1200px] px-6 py-20 lg:px-10 lg:py-28">
          ...
          <p className="mt-7 max-w-2xl text-sm font-light leading-7 text-white/55">Legal information relating to the ownership and use of the Aquí Golf website.</p>
        </div>
      </section>
      ...
      <section className="bg-[#F5F3EF] text-[#0B0B0B]">
        <div className="mx-auto max-w-[1200px] px-6 py-16 lg:px-10 lg:py-24">
          <div className="max-w-4xl space-y-10 text-sm font-light leading-7 text-black/65">
            <>
<LegalSection title="Website owner"><p>Owner: Francisco Menacho Valle<br />Trading name: Aquí Golf<br />Email: info@aquigolf.es<br />Website: aquigolf.es</p></LegalSection>
...
<LegalSection title="Intellectual property"><p>All content on this website, including text, images, logos, videos and designs, is owned by Aquí Golf or by the respective rights holders.</p></LegalSection>
<LegalSection title="Liability"><p>Aquí Golf is not responsible for improper use of the content published on this website or for possible damages arising from access to the website.</p></LegalSection>
</>
          </div>
        </div>
      </section>
